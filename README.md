...
- **Özelleştirilebilir** - Temperature ayarı ile yaratıcılık kontrolü

### 🎨 Kullanıcı Arayüzü
- **Streamlit** - Modern ve responsive web arayüzü
- **Akıllı Sohbet Arayüzü** - Chat-benzeri modern ve kullanıcı dostu tasarım
- **Sohbet Geçmişi** - Tüm konuşma geçmişini kaydetme ve görüntüleme
- **Çok Dilli Destek** - Türkçe ve İngilizce sorulara otomatik dil tespiti ile cevap
...
### RAG(Retrieval-Augmented Generation) Pipeline Akışı
...
#### 1. **Document Loader**
- Hugging Face'den veri yükleme

#### 2. **Text Splitter**
- Metinleri vektör temsillere dönüştürme
...
#### 5. **Retriever**
- En ilgili dökümanları bulma

#### 5. **LLM (Gemini)**
- Doğal dil cevabı üretme
